...
class GloVeModel():
    ...
    def train(self, num_epochs, log_dir=None, summary_batch_interval=1000, tsne_epoch_interval=None, should_save=False):
        ...
        with tf.Session(graph=self.__graph) as session:
            ...
            tf.train.write_graph(session.graph_def, log_dir, "graph.pb", False)
